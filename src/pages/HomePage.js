...
"
      ...
      description={'The Indus Group Co. offers comprehensive global logistics solutions, including cargo transportation, warehousing, and end-to-end logistics expertise, ensuring seamless, efficient, and reliable service for domestic and international markets.'}
      link="/Indusb2b"
      />
      <Card 
      photo={enterprisecard}
      heading={'Enterprise Solutions'}
      description={'The Indus Group Co. has emerged as a major player in the global market, providing cross-border services transnationally and domestically. This Indian multinational is involved in infrastructure development, energy, trade, and manufacturing across diverse sectors.'}
